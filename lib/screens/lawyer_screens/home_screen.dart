...
import '../../conts.dart';
import '../client_screens/jobs_status/active_job_screen.dart';
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>ActiveScreenLawyer()));
                          },
                          child: Text(
                            "View all >>",
                            style: TextStyle(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>AllClientsScreen()));
                          },
                          child: Text(
                            "View all >>",
                            style: TextStyle(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>LawBooksLawyer()));
                          },
                          child: Text(
                            "View all >>",
                            style: TextStyle(
