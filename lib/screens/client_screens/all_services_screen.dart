            ...
            allServices.isNotEmpty
                ? Expanded(child: (() {
                    if (filteredServices.isEmpty && hasResults) {
                      ...
                      return Center(child: Text(AppLocalizations.of(context)!.noMatchingResultsFound));
                    } else {
          ...
          return GestureDetector(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => AllServicesRelatedToCategory(
                            categoryName: name,
                            url: url,
                          )));
            },
                  ...
                  children: [
                    Container(
                        ...
                        child: CachedNetworkImage(
                          height: 100, width: double.infinity, imageUrl: url,
