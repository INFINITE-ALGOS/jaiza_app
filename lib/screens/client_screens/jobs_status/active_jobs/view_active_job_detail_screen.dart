...
class ViewActiveJobDetailScreen extends StatelessWidget {
  ...
  const ViewActiveJobDetailScreen(
          ...
          child: Column(
            ...
            children: [
              ...
              OrderSummaryRow(
                  ...
                  amount: 'PKR ${offer['offerDetails']['offerAmount']}'),
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                AcceptBookingScreen(job: job, offer: offer)));
                  },
                  child: Text(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                CancelBookingScreen(job: job, offer: offer)));
                  },
                  child: Text(
