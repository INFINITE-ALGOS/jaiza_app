...
class EditProfileScreenClient extends StatefulWidget {
  final Map<String, dynamic> profileData;
  const EditProfileScreenClient({super.key, required this.profileData});

  @override
  State<EditProfileScreenClient> createState() =>
      _EditProfileScreenClientState();
}

class _EditProfileScreenClientState extends State<EditProfileScreenClient> {
